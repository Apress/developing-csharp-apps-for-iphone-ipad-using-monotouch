...
namespace Example_SharedResources.Screens.iPhone.Contacts
{
	public partial class NewAndUnknownContactScreen : UIViewController
	{
		...
		protected ABNewPersonViewController _addressBookNewPerson;
		protected ABUnknownPersonViewController _addressBookUnknownPerson;
		...
		public override void ViewDidLoad ()
		{
			...
			this.Title = "New and Unknown Contacts";
			...
			this.btnPromptForUnknown.TouchUpInside += (s, e) => {
				...
				//---- push the controller onto the nav stack
				this.NavigationController.PushViewController(this._addressBookUnknownPerson, true);
				
				//---- handle the person created event
				this._addressBookUnknownPerson.PersonCreated += (object sender, ABUnknownPersonCreatedEventArgs args) => {
				...
				// to be perfomed.
				//this._addressBookUnknownPerson.PerformDefaultAction += (object sender, ABPersonViewPerformDefaultActionEventArgs args) => {
