...
namespace Apress.Screens.ViciCoolStorage
{
	public partial class BasicOperations : UITableViewController
	{
		protected CSList<Person> _people;
		...
		{
			CSList<Person> _items;
			
			public TableSource(CSList<Person> items) : base() { this._items = items; }
			...
			public override UITableViewCell GetCell (UITableView tableView, NSIndexPath indexPath)
			{
				...
				cell.TextLabel.Text = this._items[indexPath.Row].FirstName + " " + this._items[indexPath.Row].LastName;
				return cell;
			}
