...
namespace Example_CoreAnimation.Screens.iPad.Home
{
	public class MainSplitView : UISplitViewController
	{
		...
		protected Screens.iPad.NavTable.MasterNavTableViewController _masterView;
		protected UIViewController _detailView;
		...
		protected void HandleRowClicked(RowClickedEventArgs e)
		{
			...
			if (e.Item.Controller != null)
			{
				...
				this._detailView = e.Item.Controller;
				this.ViewControllers = new UIViewController[] { this._masterView, this._detailView};
			...
			else
			{
				if (e.Item.ControllerType != null)
				{
					...
					if (ctor != null)
					{
						...
						else { Console.WriteLine ("instance of view controller not created"); }
					}
					else { Console.WriteLine ("constructor not found"); }
				}
			}
