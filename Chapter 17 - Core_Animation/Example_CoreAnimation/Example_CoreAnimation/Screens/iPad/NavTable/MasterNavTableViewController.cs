...
namespace Example_CoreAnimation.Screens.iPad.NavTable
{
	...
	{		
		...
		public override void ViewDidLoad ()
		{
			...
			this._tableSource = new NavItemTableSource (this._navItems);
			
			//---- set the source on the table to our data source
			base.TableView.Source = this._tableSource;
			
			this._tableSource.RowClicked += (object sender, RowClickedEventArgs e) => {
				if(this.RowClicked != null) { this.RowClicked(sender, e); }
			};
		}
