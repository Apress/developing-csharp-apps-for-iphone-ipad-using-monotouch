...
namespace Example_Touch.Screens.iPhone.Home {
	...
	public partial class Home_iPhone {
		...
		private MonoTouch.UIKit.UIButton __mt_btnGenericGestureRecognizers;
		...
		[MonoTouch.Foundation.Connect("btnGenericGestureRecognizers")]
		private MonoTouch.UIKit.UIButton btnGenericGestureRecognizers {
			get {
				this.__mt_btnGenericGestureRecognizers = ((MonoTouch.UIKit.UIButton)(this.GetNativeField("btnGenericGestureRecognizers")));
				return this.__mt_btnGenericGestureRecognizers;
			}
			set {
				this.__mt_btnGenericGestureRecognizers = value;
				this.SetNativeField("btnGenericGestureRecognizers", value);
			}
		}
