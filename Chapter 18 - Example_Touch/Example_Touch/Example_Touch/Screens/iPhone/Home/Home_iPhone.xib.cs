...
namespace Example_Touch.Screens.iPhone.Home
{
	public partial class Home_iPhone : UIViewController
	{
		...
		GestureRecognizers.GenericGestureRecognizers_iPhone _genericGesturesScreen;
		...
		public override void ViewDidLoad ()
		{
			...
			this.btnGenericGestureRecognizers.TouchUpInside += (s, e) => {
				if(this._genericGesturesScreen == null)
				{ this._genericGesturesScreen = new Example_Touch.Screens.iPhone.GestureRecognizers.GenericGestureRecognizers_iPhone(); }
				this.NavigationController.PushViewController(this._genericGesturesScreen, true);
			};
