...
namespace Example_StandardControls
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		protected Example_StandardControls.Screens.iPhone.Home.HomeNavController _iPhoneHome;
		protected Example_StandardControls.Screens.iPad.Home.HomeNavController _iPadHome;
		...
		public override bool FinishedLaunching (UIApplication app, NSDictionary options)
		{
			...
			switch (this._currentDevice)
			{
				case DeviceType.iPhone:
					this._iPhoneHome = new Example_StandardControls.Screens.iPhone.Home.HomeNavController ();
