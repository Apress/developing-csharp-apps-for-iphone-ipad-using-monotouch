...
namespace Example_StandardControls.Screens.iPhone.AlertViews
{
	public partial class AlertViewsScreen_iPhone : UIViewController
	{
		...
		{
			UIAlertView alert = new UIAlertView () { Title = "alert title", Message = "this is a simple alert"	};
			alert.AddButton("OK");
			alert.Show ();
		...
		protected void HandleBtnCustomButtonsTouchUpInside (object sender, EventArgs e)
		{
			...
			this._alert = new UIAlertView () { Title = "custom buttons alert"
		...
		protected void HandleBtnCustomButtonsWithDelegateTouchUpInside (object sender, EventArgs e)
		{
			...
			this._alert = new UIAlertView ("custom buttons alert", "this alert has custom buttons"
		...
		{
			this._alert = new ActivityIndicatorAlertView ();
			(this._alert as ActivityIndicatorAlertView).Message = "performing stuff";
			this._alert.Show ();
		...
		protected void LongRunningProcess (int seconds)
		{
			...
			(this._alert as ActivityIndicatorAlertView).Hide (true);
		}
