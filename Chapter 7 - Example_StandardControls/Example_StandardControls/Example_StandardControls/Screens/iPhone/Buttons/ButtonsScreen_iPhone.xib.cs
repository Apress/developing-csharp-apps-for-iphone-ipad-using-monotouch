	...
	public partial class ButtonsScreen_iPhone : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this.btnTwo.TouchUpInside += delegate {
				UIAlertView alert = new UIAlertView ("button two click!", "TouchUpInside Handled", null, "OK", null);
				alert.Show ();
			};
		...
		{
			UIAlertView alert = new UIAlertView ("button one click!", "TouchUpInside Handled", null, "OK", null);
			alert.Show();
		}
