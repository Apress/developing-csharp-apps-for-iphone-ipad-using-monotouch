	...
	public partial class Switches_iPhone : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this.swchOne.ValueChanged += delegate {
				UIAlertView alert = new UIAlertView ("Switch one change!", "is on: " + this.swchOne.On.ToString (), null, "OK", null);
				alert.Show ();
			};
			this.swchTwo.ValueChanged += delegate {
				UIAlertView alert = new UIAlertView ("Switch two change!", "is on: " + this.swchTwo.On.ToString (), null, "OK", null);
				alert.Show ();
			};
		}
