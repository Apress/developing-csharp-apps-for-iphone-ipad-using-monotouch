...
namespace Example_StandardControls.Screens.iPhone.TextFields
{
	public partial class TextFields_iPhone : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this._textField = new UITextField (new RectangleF (20, 150, 280, 33));
			this._textField.Font = UIFont.FromName ("Helvetica-Bold", 20);
			this._textField.BorderStyle = UITextBorderStyle.Bezel;
			this._textField.Placeholder = "edit me!";
			
			this.View.AddSubview (this._textField);
		}
