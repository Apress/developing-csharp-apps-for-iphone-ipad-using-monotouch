...
namespace Example_StandardControls.Screens.iPhone.Toolbar
{
	public class ProgrammaticToolbar_Controller : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this._toolbar = new UIToolbar (new RectangleF (0
					, this.View.Frame.Height - this.NavigationController.NavigationBar.Frame.Height
					, this.View.Frame.Width, toolbarHeight));
			this._toolbar.AutoresizingMask = UIViewAutoresizing.FlexibleTopMargin | UIViewAutoresizing.FlexibleWidth;
			
			
			//---- button one
			UIBarButtonItem btnOne = new UIBarButtonItem ("One", UIBarButtonItemStyle.Bordered, null);
