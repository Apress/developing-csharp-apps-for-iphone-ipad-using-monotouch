	...
	public partial class CustomizingNavBarScreen : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this.btnChangeTintColor.TouchUpInside += (s, e) => {
				...
				else { this.NavigationController.NavigationBar.TintColor = UIColor.Red; }				
			};
			...
			this.btnChangeBarStyle.TouchUpInside += (s, e) => {
				...
				else { this.NavigationController.NavigationBar.BarStyle = UIBarStyle.Default; }
			};
			...
			this.btnShowHideRightButton.TouchUpInside += (s, e) => {
				...
				else { this.NavigationItem.SetRightBarButtonItem(null, true); }
			};
