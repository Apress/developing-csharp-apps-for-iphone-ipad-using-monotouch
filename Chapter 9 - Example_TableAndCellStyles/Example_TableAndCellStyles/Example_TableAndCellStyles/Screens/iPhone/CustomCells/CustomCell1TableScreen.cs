...
{
	public class CustomCell1TableScreen : UITableViewController
	{
		protected CustomCellTableSource _tableSource;
		protected string _cellType;
		...
		public CustomCell1TableScreen (IntPtr handle) : base(handle)
		{

		}

		[Export("initWithCoder:")]
		public CustomCell1TableScreen (NSCoder coder) : base(coder)
		{
		}
		...
		protected void CreateTableItems ()
		{
			...
			this._tableSource = new CustomCellTableSource(tableItems);
		}
		...
		public class CustomCellTableSource : TableSource
		{
			...
			protected Dictionary<int, CustomCellController1> _cellControllers = new Dictionary<int, CustomCellController1>();
			
			public CustomCellTableSource (List<TableItemGroup> items) : base(items)
			{
				this._cellIdentifier = "MyCustomCell1";
			}
